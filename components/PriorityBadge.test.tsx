...
describe('PriorityBadge', () => {
  ...
  it('renders unknown priority with default styles', () => {
      // Cast string to Priority to test the default case if somehow an invalid value is passed
      // although TS would prevent this, it's good to cover the runtime behavior
